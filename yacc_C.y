...
//%nonassoc GT GE LT LE EQL NEQL IN
...
S   :   
    |  NEWLINE_BLOCK statements  NEWLINE_BLOCK 
    ;
statements
...
exprl      
    ...
    |   exprl AND  exprl {
                                    ...
                                    temp++; }
    |   exprl LE   exprl  {
                                    sprintf(result2, "T%d", temp);
                                    insert_quad("-", $1.val, $3.val, result2);
                                    temp++; 
                                    sprintf(result, "T%d", temp);
                                    $$.val = strdup(result);
                                    
                                    sprintf(result, "(%d)", qc+3);
                                    insert_quad("BPZ", result,   result2, "");
    ...
    |   exprl GE   exprl  {
                                    ...
                                    $$.val = strdup(result);
                                    sprintf(result, "(%d)", qc+3);
                                    insert_quad("BMZ", result,   result2, "");
    ...
    |   exprl NEQL exprl  {
                                    ...
                                    $$.val = strdup(result);
                                    sprintf(result, "(%d)", qc+3);
                                    insert_quad("BNZ", result,   result2, "");
...
void yyerror(char  *msg){
    printf("\033[1;101m");
    printf("%s  ligne = %d  colonne = %d", msg, num_line, num_col);
    printf("\033[0m");
    puts("");
    errors = errors+1;
}
...
int main(int argc, char *argv[]){
    ...
    if(argc>1){
        ...
        printf("Usage: %s [filename.mpy]", argv[0]);
